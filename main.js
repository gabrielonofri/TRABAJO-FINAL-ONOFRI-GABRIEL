...
const botonesAgregar = document.getElementById("contenedorrepuestos");
...
const divcotiza = document.getElementById("divcotiza");
...
setInterval( ()=> {
    ...
    fetch(dolar)
        ...
        .then(({oficial, blue }) => {
            ...
            <h6>Dolar Oficial: ${oficial} </h6>
            <h6>Dolar Blue: ${blue}</h6>`
